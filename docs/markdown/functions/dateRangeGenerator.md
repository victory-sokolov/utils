...
[@vsokolov/utils](../modules.md) / dateRangeGenerator

# Function: dateRangeGenerator()

> **dateRangeGenerator**(`start`, `end`, `step?`): `Generator`\<`Date`\>

Defined in: [date.ts:198](https://github.com/victory-sokolov/utils/blob/65f11a56369c99065554109006908574974c4ac4/src/date.ts#L198)
