    ...
    JSX.createElement(
        ...
        Object.entries(categories).map(([key, item]) =>
            JSX.createElement(
                ...
                JSX.createElement(Navigation, { id: item.id, categories: item.categories, items: item.items, context }),
            ),
        ),
        items.map(item => JSX.createElement('li', null, JSX.createElement(Item, { item, context }))),
    );
...
const navigation = context => props => {
    ...
    return JSX.createElement(
        ...
        JSX.createElement('div', { class: 'tree-content' }, JSX.createElement(Navigation, { ...categories, context })),
    );
};
...
export function load(app) {
    app.renderer.hooks.on('head.end', context =>
        JSX.createElement('link', { rel: 'stylesheet', href: context.relativeURL('assets/hierarchy.css') }),
    );
